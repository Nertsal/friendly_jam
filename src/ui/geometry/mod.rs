use super::{Text, layout::AreaOps};

use crate::{
    assets::Assets,
    render::{Color, texture_atlas::SubTexture, util::TextRenderOptions},
};
...
impl GeometryContext {
    ...
    pub fn update(&mut self, framebuffer_size: vec2<usize>) {
        ...
        self.pixel_scale = crate::render::util::get_pixel_scale(self.framebuffer_size);
    ...
    #[must_use]
    pub fn text(&self, text: Text, position: vec2<f32>, options: TextRenderOptions) -> Geometry {
